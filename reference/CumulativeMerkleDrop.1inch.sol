...
//
// 参考用 —— 来自 1inch/merkle-distribution (MIT),仅供对照,不参与本项目编译。
// 原文件:https://github.com/1inch/merkle-distribution/blob/master/contracts/CumulativeMerkleDrop.sol
// (放在 reference/ 目录,forge 默认只编译 src/ test/ script/,不会编译这里。)
//
